...
## Hướng dẫn Build Mobile App (Expo EAS)
...
### 1. Build file để CÀI ĐẶT TEST (Preview)
...
### 2. Build & SUBMIT lên App Store & Google Play (CH Play)
...
*(Tùy chọn) Build và Tự động Submit luôn khi hoàn thành:*
```bash
# Cho iOS
